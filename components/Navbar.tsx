  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/10 bg-slate-950/75 backdrop-blur-2xl">
      <div className="mx-auto flex h-[84px] max-w-[1240px] items-center justify-between px-5 md:px-8">
        ...
        >
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-violet-600 shadow-lg shadow-blue-500/25 transition duration-300 group-hover:scale-105">
          </div>
        ...
        >
          ...
          <span className="absolute inset-0 -z-0 bg-gradient-to-r from-blue-500 to-violet-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></span>
          <span className="relative z-10 transition-colors duration-300 group-hover:text-white"></span>
        </Link>
      </div>
    </header>
  )
